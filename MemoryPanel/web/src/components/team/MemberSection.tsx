      ...
      <div className="_memory-section-header">
        ...
        {canAddMember && (
          <Button
            type="primary"
            onClick={onAdd}
            title={t('member.add.tooltip')}
            data-guide="add-member"
          >
...
function MemberCard({
  ...
  return (
    <div className="_memory-member-card">
      ...
      <div className="_memory-member-access">
        <span className="_memory-member-role">{role}</span>
        {isOwner && <span className="_memory-member-owner">{t('member.role.creator')}</span>}
      </div>
