                    ...
                    options={[
                      {
                        ...
                        text: (
                          <>
                            ...
                            <span className="sr-only">{t('asset.view.card')}</span>
                          </>
                        ),
                      },
                      {
                        ...
                        text: (
                          <>
                            ...
                            <span className="sr-only">{t('asset.view.list')}</span>
                          </>
                        ),
                      },
                    ]}
            ...
            <StatusTip
              ...
              emptyText={
                <div className="_asset-wiki-empty">
                  ...
                  {scopeTab !== 'fixed' && <Text theme="label">{t('wiki.empty.desc')}</Text>}
                </div>
              }
            />
