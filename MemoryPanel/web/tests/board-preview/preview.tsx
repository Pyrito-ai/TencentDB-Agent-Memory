...
function Preview() {
 ...
 return <main style={{padding:32}}><p style={{marginBottom:12,color:"#64748b"}}>Local preview · sample tasks · changes do not affect the live trial</p><BoardView tasks={tasks} tasksLoading={false} selected={tasks.find(t => t.task_id === id) ?? null} onSelect={setId}
